...
if ($result && $result->num_rows > 0) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "INSERT INTO DocumentRequest (ResidentID, DocumentType, Purpose, Quantity) VALUES ('{$userData['ResidentID']}', 'Barangay Certificate', '$purpose', $quantity)";
...
<head>
    ...
    <title>Barangay System | Barangay Certificate</title>
...
<body>
    ...
    <div class="p-4 main-content">
        ...
        <div class="bg-white p-4">
            <br/>
            <h4 class="text-dark text-uppercase fw-bold">Barangay Certificate</h4>

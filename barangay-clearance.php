...
if ($result && $result->num_rows > 0) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "INSERT INTO DocumentRequest (ResidentID, DocumentType, Purpose, Quantity) VALUES ('{$userData['ResidentID']}', 'Barangay Clearance', '$purpose', $quantity)";
...
<head>
    ...
    <title>Barangay System | Barangay Clearance</title>
...
<body>
    ...
    <div class="p-4 main-content">
        ...
        <div class="bg-white p-4">
            <br/>
            <h4 class="text-dark text-uppercase fw-bold">Barangay Clearance</h4>
